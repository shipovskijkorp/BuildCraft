...
public final class MjToFeAutoConverter implements IMjReceiver, IMjReadable {
    ...
    @Override
    public boolean canReceive() { return fe.canReceive() && MjAPI.isFeAutoConversionEnabled(); }
    ...
    @Override
    public long getStored() { return MjAPI.getFeConversion().feToMicroMj(fe.getEnergyStored()); }

    @Override
    public long getCapacity() { return MjAPI.getFeConversion().feToMicroMj(fe.getMaxEnergyStored()); }
}
