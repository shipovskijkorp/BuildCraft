...
public final class MjReceiverEnergyStorage implements IEnergyStorage {
    ...
    public int getEnergyStored() {
        ...
        return (int) Math.min(Integer.MAX_VALUE, BuildCraftApi.service(BuildCraftServices.ENERGY).conversion().microMjToWholeFe(readable.getStored()));
    }
    ...
    public int getMaxEnergyStored() {
        ...
        return (int) Math.min(Integer.MAX_VALUE, BuildCraftApi.service(BuildCraftServices.ENERGY).conversion().microMjToWholeFe(receiver.getPowerRequested()));
    }
}
