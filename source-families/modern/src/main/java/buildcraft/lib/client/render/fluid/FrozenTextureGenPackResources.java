...
public class FrozenTextureGenPackResources implements PackResources {
    ...
    private static final PackLocationInfo LOCATION = new PackLocationInfo(
        PACK_ID,
        Component.literal("BuildCraft generated frozen textures"),
        PackSource.BUILT_IN,
        Optional.empty()
    );
    ...
    public ResourceLocation registry(ResourceLocation srcLocation) {
        ...
        ResourceLocation generated = ResourceLocation.fromNamespaceAndPath(BCLib.MODID, "textures/" + path + ".png");
        ...
        return ResourceLocation.fromNamespaceAndPath(BCLib.MODID, path);
    }
