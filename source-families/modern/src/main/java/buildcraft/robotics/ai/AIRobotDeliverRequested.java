...
public class AIRobotDeliverRequested extends AIRobot {
    ...
    public void writeSelfToNBT(CompoundTag nbt) {
        if (requested != null) {
            ...
            requested.writeToNBT(requestTag, robot.level().registryAccess());
    ...
    public void loadSelfFromNBT(CompoundTag nbt) {
        if (nbt.contains("currentRequest")) {
            requested = StackRequest.loadFromNBT(nbt.getCompound("currentRequest"), robot.level().registryAccess());
        }
    }
}
