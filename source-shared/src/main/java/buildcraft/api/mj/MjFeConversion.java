...
public final class MjFeConversion {
    ...
    public static final long MAX_MJ_PER_FE = MjAPI.MJ / 5;
    /** Minimum MJ per FE, or maximum of 10,000 FE to make 1 MJ. */
    public static final long MIN_MJ_PER_FE = MjAPI.MJ / 10_000;
    /** Original BuildCraft 8 default: 1 MJ = 10 FE. */
    public static final long DEFAULT_MJ_PER_FE = MjAPI.MJ / 10;
    ...
    public static MjFeConversion createParsed(double configMjPerFe) {
        ...
        return new MjFeConversion(value * MjAPI.MJ / 10_000);
    }
