...
public enum ModelBuilder implements BakedModel{
	...
	public static final ResourceLocation builder = new ResourceLocation("buildcraftbuilders", "builder");
	
	public static final ResourceLocation empty = new ResourceLocation("buildcraftbuilders", "block/builder/slot_empty");
	public static final ResourceLocation blueprint = new ResourceLocation("buildcraftbuilders", "block/builder/slot_blueprint");
	public static final ResourceLocation template = new ResourceLocation("buildcraftbuilders", "block/builder/slot_template");
