...
import buildcraft.lib.gui.RecordContainerSlot;
...
public class MenuAutoWorkbenchItems extends AbstractContainerMenu {
	...
	public MenuAutoWorkbenchItems(int containerId, Inventory playerInventory, Container craft, ContainerLevelAccess access) {
		...
		this.addSlot(new ResultSlot(playerInventory.player, craft instanceof CraftingContainer a ? a : new TransientCraftingContainer(this, 3, 3), craft, 27, 124, 15));
	...
	public boolean stillValid(Player player) {
		return buildcraft.lib.gui.BCMenuUtil.stillValidBlock(this.access, player, BCFactoryBlocks.AUTO_BENCH_BLOCK.get());
	}
