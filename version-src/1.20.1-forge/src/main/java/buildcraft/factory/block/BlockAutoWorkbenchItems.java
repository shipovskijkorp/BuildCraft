...
public class BlockAutoWorkbenchItems extends BlockBCTile_Neptune {
    ...
    public BlockAutoWorkbenchItems() {
        super();
    }

	@Override
	public TileBC_Neptune newBlockEntity(BlockPos p_153215_, BlockState p_153216_) {
		return new TileAutoWorkbenchItems(p_153215_, p_153216_);
	}
	...
	public InteractionResult use(BlockState state, Level world, BlockPos pos, Player player, InteractionHand hand,
			BlockHitResult hit) {
        if (!world.isClientSide() && player instanceof ServerPlayer serverPlayer && world.getBlockEntity(pos) instanceof TileAutoWorkbenchItems tile) {
