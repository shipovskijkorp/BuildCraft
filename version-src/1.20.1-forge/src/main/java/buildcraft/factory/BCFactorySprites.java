...
public final class BCFactorySprites {
    ...
    public static final ResourceLocation DISTILLER_POWER_A =
        new ResourceLocation("buildcraftfactory:blocks/distiller/power_sprite_a");
    public static final ResourceLocation DISTILLER_POWER_B =
        new ResourceLocation("buildcraftfactory:blocks/distiller/power_sprite_b");
    public static final ResourceLocation DISTILLER_POWER_C =
        new ResourceLocation("buildcraftfactory:blocks/distiller/power_sprite_c");
    public static final ResourceLocation DISTILLER_POWER_D =
        new ResourceLocation("buildcraftfactory:blocks/distiller/power_sprite_d");
    ...
    public static final ResourceLocation HEAT_EXCHANGE =
        new ResourceLocation("buildcraftfactory:textures/gui/heat_exchanger.png");
