 ...
 * <p>
 * BuildCraft copies ordinary NeoForge item-handler capabilities generically and restores their contents after placing the
 * empty block. Mods should register an exact NBT path here only for hidden/internal inventories that are not exposed
 * through {@code Capabilities.ItemHandler.BLOCK}.
 * <p>
