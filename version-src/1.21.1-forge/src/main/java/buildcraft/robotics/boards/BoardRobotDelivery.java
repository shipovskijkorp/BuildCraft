...
public class BoardRobotDelivery extends RedstoneBoardRobot {
    ...
    public void writeSelfToNBT(CompoundTag nbt) {
        ...
        if (currentRequest != null) {
            ...
            currentRequest.writeToNBT(requestTag, robot.level().registryAccess());
    ...
    public void loadSelfFromNBT(CompoundTag nbt) {
        ...
        if (nbt.contains("currentRequest")) {
            currentRequest = StackRequest.loadFromNBT(nbt.getCompound("currentRequest"), robot.level().registryAccess());
        }
    }
}
