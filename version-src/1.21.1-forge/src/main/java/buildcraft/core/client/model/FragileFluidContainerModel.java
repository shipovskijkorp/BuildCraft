...
import static net.minecraftforge.client.model.geometry.StandaloneGeometryBakingContext.LOCATION;
...
public final class FragileFluidContainerModel implements IUnbakedGeometry<FragileFluidContainerModel> {
    ...
    public BakedModel bake(
        ...
        TextureAtlasSprite fluidSprite = fluid != Fluids.EMPTY
            ? spriteGetter.apply(ForgeHooksClient.getBlockMaterial(IClientFluidTypeExtensions.of(fluid).getStillTexture()))
            : null;
        ...
        if (fluidMaskLocation != null && fluidSprite != null) {
            ...
            if (templateSprite != null) {
                ...
                var unbaked = UnbakedGeometryHelper.createUnbakedItemMaskElements(1, templateSprite.contents());
        ...
        if (coverSprite != null) {
            ...
            if (sprite != null) {
                ...
                var unbaked = UnbakedGeometryHelper.createUnbakedItemMaskElements(2, coverSprite.contents());
    ...
    private static final class ContainedFluidOverrideHandler extends ItemOverrides {
        ...
        public BakedModel resolve(
            ...
            ResourceLocation name = ForgeRegistries.FLUIDS.getKey(containedFluid);
            if (name == null) {
                return originalModel;
            }
