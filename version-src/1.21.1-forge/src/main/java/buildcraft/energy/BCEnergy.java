...
public class BCEnergy {
    ...
    private static final ResourceLocation ADVANCEMENT_FIND_OIL_SPOT = ResourceLocation.fromNamespaceAndPath(MODID, "fine_riches");
    ...
    public void gatherData(GatherDataEvent event) {
        ...
        event.getGenerator().addProvider(event.includeServer(), new BCEnergyRecipes.BCEnergyRecipeProvider(output, event.getLookupProvider()));
