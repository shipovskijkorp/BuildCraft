...
public final class BCEnergyFluids {
    ...
    public static final TagKey<Fluid> IS_OIL = TagKey.create(Registries.FLUID, ResourceLocation.fromNamespaceAndPath(BCEnergy.MODID, "is_oil"));
    public static final TagKey<Fluid> IS_FUEL = TagKey.create(Registries.FLUID, ResourceLocation.fromNamespaceAndPath(BCEnergy.MODID, "is_fuel"));
    ...
    private static void registerFluidCompatibility() {
        ...
        for (String name : NAME) {
            for (int heat = 0; heat < HEAT_NAMES.length; heat++) {
                ...
                TagKey<Fluid> tag = TagKey.create(Registries.FLUID, ResourceLocation.fromNamespaceAndPath("forge", commonName));
    ...
    private static void defineFluid(int[] data, int heat, String name) {
        ...
        RegistryObject<BCFluid> source = RegistryObject.create(
            ResourceLocation.fromNamespaceAndPath(BCEnergy.MODID, fullName), ForgeRegistries.Keys.FLUIDS, BCEnergy.MODID
        );
        RegistryObject<BCFluid> flowing = RegistryObject.create(
            ResourceLocation.fromNamespaceAndPath(BCEnergy.MODID, fullName + "_flowing"), ForgeRegistries.Keys.FLUIDS, BCEnergy.MODID
        );
