...
public class BCFactoryRecipesProvider extends RecipeProvider {
    public BCFactoryRecipesProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
    ...
    protected void buildRecipes(RecipeOutput writer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, BCFactoryItems.AUTO_BENCH_ITEM.get())
            ...
            .save(writer, ResourceLocation.fromNamespaceAndPath(BCFactory.MODID, "autowork_bench_1"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, BCFactoryItems.AUTO_BENCH_ITEM.get())
            ...
            .unlockedBy("has_" + BCCoreItems.GEAR_STONE.getId().getPath(),
                TriggerInstance.hasItems(BCCoreItems.GEAR_STONE.get()))
            .save(writer, ResourceLocation.fromNamespaceAndPath(BCFactory.MODID, "autowork_bench_2"));
    }
}
