...
public class BlockLaserTable extends BlockBCTile_Neptune implements ILaserTargetBlock {
 ...
 /*   @Override
    ...
    protected InteractionResult useWithoutItem(BlockState state, Level world, BlockPos pos, Player player,
            BlockHitResult hit) {
        activate(world, pos, player, InteractionHand.MAIN_HAND, hit);
        return InteractionResult.SUCCESS;
    }

    private static void activate(Level world, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hit) {
