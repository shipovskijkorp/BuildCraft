...
public class FluidUtilBC {
    ...
    public static boolean onTankActivated(Player player, BlockPos pos, InteractionHand hand,
        ...
        if (held.getItem() instanceof BucketItem bucketItem && bucketItem.getFluid() != Fluids.EMPTY) {
            FluidStack bucketFluid = new FluidStack(bucketItem.getFluid(), FluidType.BUCKET_VOLUME);
