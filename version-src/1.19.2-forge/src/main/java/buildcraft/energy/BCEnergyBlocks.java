...
public class BCEnergyBlocks {
    ...
    public static final RegistryObject<MultiBlockItem<EnumEngineType>> ENGINE_FE_ITEM = BCEnergy.ITEMS.register("engine_fe", () -> new MultiBlockItem<EnumEngineType>(BCCoreBlocks.ENGINE_BC8.get(),new Item.Properties().tab(BCCore.BUILDCRAFT_TAB), EnumEngineType.FE, BCCoreItems.ENGINE_ITEM_MAP));

    public static final RegistryObject<BlockDynamoMJ> DYNAMO_MJ = BLOCKS.register("mj_dynamo", () -> new BlockDynamoMJ(BlockBehaviour.Properties.of(Material.METAL).strength(5.0F).explosionResistance(10.0F)));
    public static final RegistryObject<BlockItem> DYNAMO_MJ_ITEM = BCEnergy.ITEMS.register("mj_dynamo", () -> new BlockItem(DYNAMO_MJ.get(), new Item.Properties().tab(BCCore.BUILDCRAFT_TAB)));
    ...
    public static final RegistryObject<BlockEntityType<TileEngineFE>> ENGINE_FE_TILE_BC8 = BLOCK_ENTITYS.register("entity_fe_engine",
            () -> BlockEntityType.Builder.of(TileEngineFE::new, BCCoreBlocks.ENGINE_BC8.get()).build(null));
    public static final RegistryObject<BlockEntityType<TileDynamoMJ>> DYNAMO_MJ_TILE = BLOCK_ENTITYS.register("entity_mj_dynamo",
