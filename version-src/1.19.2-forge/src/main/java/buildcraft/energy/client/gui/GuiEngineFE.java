...
public class GuiEngineFE extends GuiBC8<ContainerEngineFE> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("buildcraftenergy:textures/gui/fe_engine_gui.png");
    ...
    protected void drawForegroundLayer(PoseStack pose, int mouseX, int mouseY) {
        ...
        font.draw(pose, title, (int) titleX, (int) titleY, 0x404040);
        font.draw(pose, playerInventoryTitle,
            (int) mainGui.rootElement.getX() + inventoryLabelX,
            (int) mainGui.rootElement.getY() + inventoryLabelY, 0x404040);
    }

    @Override
    protected void drawBackgroundLayer(PoseStack pose, int mouseX, int mouseY, float partialTicks) {
        GUI.drawAt(pose, mainGui.rootElement);
        if (container.tile != null) {
            ...
            FE.drawCutInside(pose, new GuiRectangle(31, 78 - height, 6, height).offset(mainGui.rootElement));
        }
        ...
        OVERLAY.drawAt(pose, mainGui.rootElement.offset(57, 18));
