...
import buildcraft.builders.snapshot.pattern.PatternHorizon;
import buildcraft.builders.snapshot.pattern.PatternFlatten;
import buildcraft.builders.snapshot.pattern.PatternCylinder;
